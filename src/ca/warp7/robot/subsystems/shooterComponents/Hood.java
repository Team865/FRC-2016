...
public class Hood extends IterativeRobot {
    ...
    public Hood(CANTalon hood) {
        ...
        //hood.configEncoderCodesPerRev(XXX), // if using FeedbackDevice.QuadEncoder
        //hood.configPotentiometerTurns(XXX), // if using FeedbackDevice.AnalogEncoder or AnalogPot
