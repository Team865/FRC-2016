...
/**
 * Handle input from standard Xbox controllers connected to the Driver Station. This
...
public class XboxController extends GenericHID {
  ...
  /**
   * Construct an instance of a controller. The controller index is the usb port on
   * the drivers station.
   *
  ...
  /**
   * Get the left trigger value of the controller. This depends on the mapping of the
   * controller connected to the current port.
   *
   * @param hand Unused
  ...
  /**
   * Get the right trigger value of the controller. This depends on the mapping of the
   * controller connected to the current port.
   *
   * @param hand Unused
   ...
   *
   * Look up which button has been assigned to the 'a' button and read its state.
   *
   * @param hand This parameter is ignored for the XboxController class and is only
   ...
   *
   * Look up which button has been assigned to the 'b' button and read its state.
   *
   * @param hand This parameter is ignored for the XboxController class and is only
   *        here to complete the GenericHID interface.
   * @return The state of the a button.
   ...
   *
   * Look up which button has been assigned to the 'x' button and read its state.
   *
   * @param hand This parameter is ignored for the XboxController class and is only
   *        here to complete the GenericHID interface.
   * @return The state of the a button.
   ...
   *
   * Look up which button has been assigned to the 'y' button and read its state.
   *
   * @param hand This parameter is ignored for the XboxController class and is only
   *        here to complete the GenericHID interface.
   * @return The state of the a button.
   ...
   *
   * Look up which button has been assigned to the left bumper and read its state.
   *
   * @param hand This parameter is ignored for the XboxController class and is only
   *        here to complete the GenericHID interface.
   * @return The state of the a button.
   ...
   *
   * Look up which button has been assigned to the right bumper and read its state.
   *
   * @param hand This parameter is ignored for the XboxController class and is only
   *        here to complete the GenericHID interface.
   * @return The state of the a button.
   ...
   *
   * Look up which button has been assigned to the 'back' button and read its state.
   *
   * @param hand This parameter is ignored for the XboxController class and is only
   *        here to complete the GenericHID interface.
   * @return The state of the a button.
   ...
   *
   * Look up which button has been assigned to the 'start' button and read its state.
   *
   * @param hand This parameter is ignored for the XboxController class and is only
   *        here to complete the GenericHID interface.
   * @return The state of the a button.
   ...
   *
   * Look up which button has been assigned to the left stick button and read its state.
   *
   * @param hand This parameter is ignored for the XboxController class and is only
   *        here to complete the GenericHID interface.
   * @return The state of the a button.
   ...
   *
   * Look up which button has been assigned to the right stick button and read its state.
   *
   * @param hand This parameter is ignored for the XboxController class and is only
   *        here to complete the GenericHID interface.
   * @return The state of the a button.
   ...
   * @return the angle of the DPad in degrees, or -1 if the POV is not pressed.
   */
  public int getDPad() {
  ...
  /**
   * Get the magnitude of the direction vector formed by the controller's current
  ...
  /**
   * Get the direction of the vector formed by the controller and its origin in
   * radians
   *
  ...
  /**
   * Set the rumble output for the controller. The DS currently supports 2 rumble
